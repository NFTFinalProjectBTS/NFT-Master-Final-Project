...
plt.savefig("sentimentpiechart_cryptopunks.png")
...
tw_list.to_csv('tw_sentiment_df.csv')
...
count_vect_df.to_csv("countvect_df.csv")
...
countdf.to_csv("cryptopunks_wordcount.csv")
